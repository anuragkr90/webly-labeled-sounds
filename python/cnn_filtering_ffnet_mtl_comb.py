...
def netFeatTrain(net,train_data,optimizer,loss_fn,epoch):
    ...
    for batch in train_data:
        ...
        optimizer.zero_grad()
        batch_pred1, batch_pred2, batch_pred = net(indata1,indata2)
...
def netFeatVald(net,vald_data,loss_fn,epoch):
    ...
    for batch in vald_data:
        ...
        if args.div_apply[0] == 'Y':
            ...
            batch_val_loss3 = div_factor * loss_div_outs(batch_pred1,batch_pred2,div_type)
            batch_val_loss = batch_val_loss + batch_val_loss3
